...
void CSpreadSheet::GetCellBorder(long lCol, long lRow, short nIndex, VARIANT* pcrColor, VARIANT* pnStyle)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I2 VTS_PVARIANT VTS_PVARIANT;
...
void CSpreadSheet::SetCellBorder(long lCol, long lRow, long lCol2, long lRow2, short nIndex, unsigned long crColor, long nStyle)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I2 VTS_I4 VTS_I4;
...
void CSpreadSheet::SetTextMatrix(long Row, long Col, LPCTSTR propVal)
{
	SetRow(Row);
	SetCol(Col);
	SetText(propVal);
...
CString CSpreadSheet::GetTextMatrix(long Row, long Col)
{
	SetRow(Row);
	SetCol(Col);
