...
namespace VisionCom
{
    // int32를 little-endian 바이트로 추가 (VS2010 호환, inline으로 헤더 구현)
    static inline void AppendInt32(std::vector<uint8_t>& payload, int32_t v)
    {
    ...
    static inline bool TryReadInt32LE(const std::vector<uint8_t>& bytes, size_t offset, int32_t& out)
    {
