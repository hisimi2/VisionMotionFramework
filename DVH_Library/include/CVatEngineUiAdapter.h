...
namespace DVH_VAT
{
    ...
    public:
        ...
        // 메시지 ID를 얻음 (RegisterWindowMessage 기반, v100 태그 포함)
        ...
        bool StartVatSequence(IVatActuator* adapter)
        {
            ...
            VatSequenceStrategyPtr strategy = boost::make_shared<StrategyType>();
    ...
    private:
        // 내부 동기화 및 구현 세부사항
        mutable boost::mutex m_seqMutex;
