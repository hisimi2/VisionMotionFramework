...
void CEquipment2015Dlg::OnBnClickedVmfStateMachine()
{
    ...
    if (started)
    {
        AppendLog(_T("[StateMachine Mode] Sequence 'Load1ZFocus' started successfully.\r\n"));
    }
    else
    {
...
//=============================================================================
// [예제] VMF 상태머신 모드 - ConnectionManager 사용 (다중 서버 대응)
//=============================================================================
...
//=============================================================================
static std::shared_ptr<VMF::Orchestrator> CreateServerOrchestrator(
    HWND hWnd,
    LPCTSTR name,
...
void CEquipment2015Dlg::OnBnClickedVmfMultiServerExample()
{
    ...
    auto orch1 = CreateServerOrchestrator(m_hWnd, _T("ServerA"), configA);
    bool started1 = orch1->StartSequence<
        VMF_Load1::Load1LeftPlateFocusCheckStrategy
    >(nullptr, configA);
    ...
    auto orch2 = CreateServerOrchestrator(m_hWnd, _T("ServerA-2"), configA);
    bool started2 = orch2->StartSequence<
        VMF_Load1::Load1LeftPlateFocusCheckStrategy
    >(nullptr, configA);
    ...
    auto orch3 = CreateServerOrchestrator(m_hWnd, _T("ServerB"), configB);
    bool started3 = orch3->StartSequence<
        VMF_Load1::Load1LeftPlateFocusCheckStrategy
    >(nullptr, configB);
