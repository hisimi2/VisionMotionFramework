...
void CLoad1MoveToStartPositionTask::OnInitialize(Context& ctx)
{
...
TaskResult CLoad1MoveToStartPositionTask::OnPoll(Context& ctx, IActuator* actuator)
{
	switch (GetState())
	{
...
TaskResult CLoad1MoveToStartPositionTask::HandleMoveSafeZ(
...
TaskResult CLoad1MoveToStartPositionTask::HandleMoveOrigin(
	Context& ctx, IActuator* actuator)
{
	if (!actuator)
		return SetErrorAndReturn(ctx, "MoveToStartPosition: actuator is null.");
...
TaskResult CLoad1MoveToStartPositionTask::HandleMoveTargetPositionXY(
	Context& ctx, IActuator* actuator)
{
	if (!actuator)
		return SetErrorAndReturn(ctx, "MoveToStartPosition: actuator is null.");
...
TaskResult CLoad1MoveToStartPositionTask::HandleMoveTargetPositionZ(
	Context& ctx, IActuator* actuator)
{
	if (!actuator)
		return SetErrorAndReturn(ctx, "MoveToStartPosition: actuator is null.");
...
TaskResult CLoad1MoveToStartPositionTask::HandleCompleteMove(
	Context& ctx, IActuator* actuator)
{
	if (!actuator)
		return SetErrorAndReturn(ctx, "MoveToStartPosition: actuator is null.");
