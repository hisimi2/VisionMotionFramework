...
void CLoad1VATCommitPickerCamDistanceResultsTask::OnInitialize(VMF::Context& ctx)
{
	m_currentUpperCameraIndex = 0;
	m_currentPitchMode = VMF::Narrow;
...
VMF::TaskResult CLoad1VATCommitPickerCamDistanceResultsTask::OnPoll(
	VMF::Context& ctx,
...
VMF::TaskResult CLoad1VATCommitPickerCamDistanceResultsTask::HandleGetStdPickerPos(
	VMF::Context& ctx,
	VMF::IActuator* actuator)
{
	auto repo = ctx.GetRepository();
...
VMF::TaskResult CLoad1VATCommitPickerCamDistanceResultsTask::HandleCalcCamAlignPos(
	VMF::Context& ctx,
	VMF::IActuator* actuator)
{
